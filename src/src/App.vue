...
<template>
  <header
    class="bg-white px-8 py-4 flex justify-between items-center sticky top-0"
  ...
  >
    ...
    <nav class="nav">
      ...
      <RouterLink to="/zipcode">郵便番号</RouterLink>
    </nav>
  </header>
  ...
  <footer class="text-center p-5 mt-10 text-[#888]">
